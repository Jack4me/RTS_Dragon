    ...
    public class FogComponent : MonoBehaviour {
        ...
        private void UpdateUnit(GameObject unit)
        {
            Ray ray = new Ray(UnityEngine.Camera.main.transform.position, 
                unit.transform.position - UnityEngine.Camera.main.transform.position);
            RaycastHit hit;
        ...
        private void ClearInitialArea() {
            ...
            List<Vector3> area = new List<Vector3>
            {
                ...
                new Vector3(0, fogPosY, -distance), //bot-center
                new Vector3(-distance, fogPosY, -distance), //bot-left
                new Vector3(distance, fogPosY, -distance), //bot-right
            };
